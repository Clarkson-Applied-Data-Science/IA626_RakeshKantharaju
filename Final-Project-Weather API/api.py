...
def getTableData_by_placename_by_date():
    ...
    # return render_template('get_data.html',tables=[df.to_html(classes='data')], titles=df.columns.values)
...
# http://10.2.3.251:5000/get_nearest_stations?key=123&lat=44.6592&lon=-74.9681&n=15
# http://10.2.3.251:5000/getTableData_nearest_stations?key=123&lat=44.6592&lon=-74.9681&n=2
# http://10.2.3.251:5000/getData_by_station_id_by_date?key=123&station_id=2473&date=2022-01-01
# http://10.2.3.251:5000/getData_by_station_id_by_daterange?key=123&station_id=2473&start_date=2022-01-01&end_date=2022-01-02
# http://10.2.3.251:5000/getTableData_by_station_id_by_daterange?key=123&station_id=2473&start_date=2022-01-01&end_date=2022-01-02
# http://10.2.3.251:5000/getData_by_zip_by_date?key=123&zipcode=13676&date=2022-01-01
# http://10.2.3.251:5000/getData_by_zip_by_daterange?key=123&zipcode=13676&start_date=2022-01-01&end_date=2022-01-02
# http://10.2.3.251:5000/getTableData_by_zip_by_daterange?key=123&zipcode=13676&start_date=2022-01-01&end_date=2022-01-10
# http://10.2.3.251:5000/getData_by_placename_by_date?key=123&place_name=potts&country_code=us&date=2022-01-01
# http://10.2.3.251:5000/getTableData_by_placename_by_date?key=123&place_name=potts&country_code=us&date=2022-01-01
# http://10.2.3.251:5000/getData_by_zip_by_date_by_hour?key=123&zipcode=13676&date=2022-01-01&hour=13
# http://10.2.3.251:5000/getData_by_zip_by_date_all_hours?key=123&zipcode=13676&date=2022-01-01
# http://10.2.3.251:5000/getTableData_by_zip_by_date_all_hours?key=123&zipcode=13676&date=2022-01-01